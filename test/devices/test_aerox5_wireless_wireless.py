...
from rivalcfg.devices import aerox5_wireless_wireless
...
class TestDevice(object):
    ...
    def mouse(self):
        settings = mouse_settings.FakeMouseSettings(
            0x1038,
            0xBAAD,
            aerox5_wireless_wireless.profile,
        )
        return mouse.Mouse(
            usbhid.FakeDevice(),
            aerox5_wireless_wireless.profile,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (200, b"\x02\x00\x6d\x01\x00\x02"),
            (300, b"\x02\x00\x6d\x01\x00\x03"),
            (18000, b"\x02\x00\x6d\x01\x00\xd6"),
            ("200,400", b"\x02\x00\x6d\x02\x00\x02\x04"),
            ("200,400,800,1600", b"\x02\x00\x6d\x04\x00\x02\x04\x09\x12"),
        ],
    )
