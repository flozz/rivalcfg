...
class TestDevice(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            (100, b"\x02\x00\x2c\x01\x01\x00\x00"),
            (200, b"\x02\x00\x2c\x01\x01\x02\x02"),
            (300, b"\x02\x00\x2c\x01\x01\x03\x03"),
            (18000, b"\x02\x00\x2c\x01\x01\xd6\xd6"),
            ("200,400", b"\x02\x00\x2c\x02\x01\x02\x04\x02\x04"),
            (
                "200:300,400:500,800,1600",
                b"\x02\x00\x2c\x04\x01\x02\x04\x09\x12\x03\x05\x09\x12",
            ),
        ],
    )
