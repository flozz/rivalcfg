...
from rivalcfg.devices import sensei310
...
class TestDevice(object):
    ...
    @pytest.fixture
    def mouse(self):
        return mouse.Mouse(usbhid.FakeDevice(), sensei310.profile)
    ...
    @pytest.mark.parametrize("value,expected_hid_report", [
        ("default", b"\x02\x00\x31\x00\x01\x00\x00\x00\x00\x02\x00\x00\x00\x00\x03\x00\x00\x00\x00\x04\x00\x00\x00\x00\x05\x00\x00\x00\x00\x51\x4E\x00\x00\x00\x51\x4B\x00\x00\x00\x30\x00\x00\x00\x00"),  # noqa
        ("buttons(button2=button6)", b"\x02\x00\x31\x00\x01\x00\x00\x00\x00\x06\x00\x00\x00\x00\x03\x00\x00\x00\x00\x04\x00\x00\x00\x00\x05\x00\x00\x00\x00\x51\x4E\x00\x00\x00\x51\x4B\x00\x00\x00\x30\x00\x00\x00\x00"),  # noqa
        ({"buttons": {"button2": "button6"}}, b"\x02\x00\x31\x00\x01\x00\x00\x00\x00\x06\x00\x00\x00\x00\x03\x00\x00\x00\x00\x04\x00\x00\x00\x00\x05\x00\x00\x00\x00\x51\x4E\x00\x00\x00\x51\x4B\x00\x00\x00\x30\x00\x00\x00\x00"),  # noqa
        ])
