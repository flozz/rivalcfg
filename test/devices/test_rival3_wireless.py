...
class TestDevice(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (200, b"\x02\x00\x20\x01\x01\x02\x00"),
            (300, b"\x02\x00\x20\x01\x01\x03\x00"),
            (18000, b"\x02\x00\x20\x01\x01\xd6\x00"),
            ("200,400", b"\x02\x00\x20\x02\x01\x02\x00\x04\x00"),
            (
                "200,400,800,1600",
                b"\x02\x00\x20\x04\x01\x02\x00\x04\x00\x09\x00\x12\x00",
            ),
        ],
    )
