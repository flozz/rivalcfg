...
def _check_linux():
    ...
    if not os.path.isfile(udev.RULES_FILE_PATH):
        sys.stderr.write("W: udev rules are not installed. You may not be able to open the device using a regular user.\n")  # noqa
        sys.stderr.write("   Run 'rivalcfg --update-udev' as root to fix.\n\n")
    elif not udev.is_rules_file_up_to_date():
        sys.stderr.write("W: Installed udev rules were generated by an other rivalcfg version.\n")  # noqa
